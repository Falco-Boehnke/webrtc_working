System.register(["ws", "../NetworkMessages", "../DataCollectors/Enumerators/EnumeratorCollection", "../DataCollectors/Client", "./AuthoritativeServerEntity"], function (exports_1, context_1) {
    "use strict";
    var WebSocket, NetworkMessages, TYPES, Client_1, AuthoritativeServerEntity_1, AuthoritativeSignalingServer;
    ...
    return {
        setters: [
            ...
            function (AuthoritativeServerEntity_1_1) {
                AuthoritativeServerEntity_1 = AuthoritativeServerEntity_1_1;
            }
        ],
        execute: function () {
            AuthoritativeSignalingServer = class AuthoritativeSignalingServer {
            ...
            exports_1("AuthoritativeSignalingServer", AuthoritativeSignalingServer);
        }
    };
});
