System.register(["../NetworkMessages", "../DataCollectors/Enumerators/EnumeratorCollection", "./AuthoritativeSignalingServer"], function (exports_1, context_1) {
    "use strict";
    var NetworkMessages, TYPES, AuthoritativeSignalingServer_1, AuthoritativeServerEntity;
    ...
    return {
        ...
        execute: function () {
            AuthoritativeServerEntity = class AuthoritativeServerEntity {
                constructor() {
            ...
            exports_1("AuthoritativeServerEntity", AuthoritativeServerEntity);
        }
    };
});
