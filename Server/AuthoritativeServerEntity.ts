...
export class AuthoritativeServerEntity {
    ...
    public notYetPeerConnectedClientCollection: FudgeNetwork.Client[] = new Array();
    ...
    public addIceCandidateToServerConnection = async (_receivedIceMessage: FudgeNetwork.NetworkMessageIceCandidate) => {
        if (_receivedIceMessage.candidate) {
            let client: FudgeNetwork.Client = this.searchUserByUserIdAndReturnUser(_receivedIceMessage.originatorId, this.notYetPeerConnectedClientCollection);
    ...
    public receiveAnswerAndSetRemoteDescription = (_websocketClient: any, _answer: FudgeNetwork.NetworkMessageRtcAnswer) => {
        ...
        let clientToConnect: FudgeNetwork.Client = this.searchUserByWebsocketConnectionAndReturnUser(_websocketClient, this.notYetPeerConnectedClientCollection);
    ...
    private disconnectClientByOwnCommand = (_commandMessage: FudgeNetwork.PeerMessageDisconnectClient) => {
        let clientToDisconnect: FudgeNetwork.Client = this.searchUserByUserIdAndReturnUser(_commandMessage.originatorId, this.notYetPeerConnectedClientCollection);
